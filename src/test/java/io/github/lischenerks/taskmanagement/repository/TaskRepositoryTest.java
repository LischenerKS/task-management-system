...
public class TaskRepositoryTest {
    ...
    static void setUp(@Autowired TaskRepository repository) {
        entity1 = repository.save(new TaskEntity(
                null,
                0L,
                0L,
                TaskStatus.CREATED,
        ...
        entity2 = repository.save(new TaskEntity(
                null,
                1L,
                1L,
        ...
        entity3 = repository.save(new TaskEntity(
                null,
                2L,
                2L,
                TaskStatus.DONE,
    ...
    void getAllTasksWithFilters_filtersByStatus() {
        Assertions.assertEquals(
                repository.getAllTasksWithFilters(null, null, TaskStatus.CREATED, null, Pageable.ofSize(10)),
                List.of(entity1)
        );

        Assertions.assertEquals(
                repository.getAllTasksWithFilters(null, null, TaskStatus.IN_PROGRESS, null, Pageable.ofSize(10)),
                List.of(entity2)
        );

        Assertions.assertEquals(
                repository.getAllTasksWithFilters(null, null, TaskStatus.DONE, null, Pageable.ofSize(10)),
                List.of(entity3)
        );
    }
    ...
    void getAllTasksWithFilters_filtersByPriority() {
        Assertions.assertEquals(
                repository.getAllTasksWithFilters(null, null, null, TaskPriority.LOW, Pageable.ofSize(10)),
                List.of(entity1)
        );

        Assertions.assertEquals(
                repository.getAllTasksWithFilters(null, null, null, TaskPriority.MEDIUM, Pageable.ofSize(10)),
                List.of(entity2)
        );

        Assertions.assertEquals(
                repository.getAllTasksWithFilters(null, null, null, TaskPriority.HIGH, Pageable.ofSize(10)),
                List.of(entity3)
        );
    }
